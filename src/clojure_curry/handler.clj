(ns clojure-curry.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [clojure-curry.routes.home :refer [home-routes]]
            
            [clojure-curry.middleware :as middleware]
            [clojure-curry.session :as session]
...
(defn init
  ...
  (timbre/info "\n-=[ clojure-curry started successfully"
...
(defn destroy
  ...
  []
  (timbre/info "clojure-curry is shutting down...")
  (stop-nrepl)
